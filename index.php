...
<div id="maincontainer">
	...
	<div="contents">
		...
		<div id="aboutcontent" class="contentitem" style="display: none;">
			...
			<p>Before moving to Andover just last month, I spent two years working as a Technical Coordinator for Epic Systems in Madison, WI. As a Technical Coordinator I managed large-scale healthcare software implementation projects, developed tools for internal and external audiences, and provided technical support for a range of applications.</p>
			<p>I currently hold a BA degree from Emory University where I studied Economics, Middle Eastern Studies, and the Arabic language. I still love all things liberal arts and am interested in revisiting my international interests in the not-too-distant future.</p>
			<p>My mother is a public parks administrator, tutor, and graphic designer, and my father is a professor of Anthropology. My older brother is a lighting console programmer for live productions on Broadway and my younger brother is in his senior year of highschool, hopging to attend Georgia Tech next fall.</p>
